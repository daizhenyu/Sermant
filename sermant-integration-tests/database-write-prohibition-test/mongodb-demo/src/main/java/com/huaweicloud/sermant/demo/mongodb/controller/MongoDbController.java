...
public class MongoDbController {
    ...
    public int createCollection(String databaseName, String collectionName) {
        try {
    ...
    public int dropCollection(String databaseName, String collectionName) {
        try {
            MongoDatabase database = mongoClient.getDatabase(databaseName);
    ...
    public int createIndex(String databaseName, String collectionName, String fieldName) {
        try {
            MongoDatabase database = mongoClient.getDatabase(databaseName);
    ...
    public int deleteIndex(String databaseName, String collectionName, String fieldName) {
        try {
            MongoDatabase database = mongoClient.getDatabase(databaseName);
    ...
    public int insertDocument(String databaseName, String collectionName, String fieldName, String value) {
        try {
            MongoDatabase database = mongoClient.getDatabase(databaseName);
    ...
    public int deleteDocument(String databaseName, String collectionName, String fieldName, String value) {
        try {
            MongoDatabase database = mongoClient.getDatabase(databaseName);
    ...
    public int updateDocument(String databaseName, String collectionName, String fieldName, String value) {
        try {
            MongoDatabase database = mongoClient.getDatabase(databaseName);
    ...
    public int replaceDocument(String databaseName, String collectionName, String fieldName, String value) {
        try {
            MongoDatabase database = mongoClient.getDatabase(databaseName);
