...
public class AlibabaDubboConsumer {
    ...
    private com.huaweicloud.demo.alibabadubbo.api.service.AlibabaGreetingService greetingInnerService;
     ...
     * @return 流量标签值
     */
    @RequestMapping(value = "consumer", method = RequestMethod.GET, produces = MediaType.TEXT_PLAIN_VALUE)
    @ResponseBody
    public String alibabaDubbo() {
