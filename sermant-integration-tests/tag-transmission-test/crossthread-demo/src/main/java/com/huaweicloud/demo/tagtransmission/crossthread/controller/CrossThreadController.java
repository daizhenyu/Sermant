...
public class CrossThreadController {
     ...
     * @throws InterruptedException
     */
    @RequestMapping(value = "testScheduleAtFixedRate", method = RequestMethod.GET, produces = MediaType.TEXT_PLAIN_VALUE)
     ...
     * @throws InterruptedException
     */
    @RequestMapping(value = "testScheduleWithFixedDelay", method = RequestMethod.GET, produces = MediaType.TEXT_PLAIN_VALUE)
